def engineer_before_snap_features(df):
    pass
...
# Identify frame before ball_snap
...
df_ranked = df_all_with_te.withColumn("position_index", row_number().over(window))
...
for n_te in [0, 1, 2]:
    ...
    clf = RandomForestClassifier(
        n_estimators=190, max_depth=11, min_samples_split=5,
